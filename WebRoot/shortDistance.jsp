...
<head>
    ...
    <meta name="keywords"
          content="聚玩吧拼车是一个提供大家回家、旅游、上班等拼车网站，由于该系统初次开发，可能在各个方面做得都不是很足，希望使用者能在使用过程中遇到了什么不合适的地方，务必联系799123897@qq.com，我们将尽力去完善我们的系统"/>
        ...
        <div class="header">
            ...
            <div class="navg">
                <ul class="res">
                    ...
                    <li><a class="active" href="shortDistance.jsp">短程拼车</a></li>
    ...
    <div class="container">
        <div class="blog-main">
            ...
            <div class="col-md-7 blog-right" style="padding-left: 12px;">
                <!--<h3 align="center">短程拼车信息</h3>-->
                <span style="display: block;font-size: 24px;text-align: center;color: #9B242D">短程拼车信息</span>
                <ul class="blog-rig-list">
                    <li>
                        <table style="width:98%;">
                            ...
                            <tr>
                                ...
                                <td style="width:15%">出发城市</td>
                                <td style="width:15%">目地城市</td>
                                <!--<td style="width:10%">可申请人数</td>-->
                    ...
                    <li>
                        <table style="width:98%;">
                            <tbody>
                            <tr onmousemove="console.log(this.nextSibling.nextElementSibling.setAttribute('style','background: grey;font-size:12px;display:'))" onmouseout="this.nextSibling.nextElementSibling.setAttribute('style','display:none')">
                            ...
                            <tr style="background: grey;font-size:12px;display: none">
                                <td style="width:10%">车主</td>
                                <td style="width:20%">2016/01/02</td>
                                <td style="width:10%">20<span>元</span></td>
                                <td style="width:10%">轿车</td>
...
<script type="text/javascript" src="js/short_baidu.js">
</script>