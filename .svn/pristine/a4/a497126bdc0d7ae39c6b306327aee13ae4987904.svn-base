...
<script language="javascript" type="text/javascript" src="js/jquery-2.0.2.min.js"/> 

<!-- <script src="bootstrap-3.3.5/js/vendor/jquery.min.js"></script>  -->
<!-- <script src="../../assets/js/ie10-viewport-bug-workaround.js"></script> -->
<script type="text/javascript"> 
$(document).ready(function(){ //$是JQurey程序的标志 
alert("您好，欢迎来到JQuery世界!");
var page=$(".pagination > li");
/* var pagination=page.first(); */
(function($){
getNext(){
   page.each(function(){
	if($(this).attr('class')=='active'){
		$(this).Attr('class').removeClass("active");
		$(this).next().Attr('class').addClass("active");
	}
});
};
})($);
		...
		<div style="width:70%;float:right">
			...
			<nav>
  				<ul class="pagination">
    				...
    				<li><a href="#">5</a></li>
    				<li>
     				 <a  aria-label="Next" onclick="getNext();">
